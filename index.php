<?php
$tarih1 = new DateTime("2025-01-30");
...
<head>
    ...
    <title>EfeDam ❤️ <?php echo $interval->days ?> </title>
            ...
            <div class="ay">
                    <div class="row p-0 m-0 h-100 text-white text-center ">
                        <div class="col-md-12 text-white text-center">
                            ...
                            <p class="lead" id="mesaj"><?php echo $kac_kisi ?> Kişi Mutluluklar Diledi 😊 </p>
